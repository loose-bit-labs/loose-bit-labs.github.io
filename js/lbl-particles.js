...
const AREAS = {
	AI:     { color:[1,0,0], terms: 'Stable Diffusion, Automatic1111, ComfyUI, Bark, Whisper, MusicGen, Piper, Diffusers, CharacterGen, ollama, llamacpp, koboldcpp, muscleLLM, Face Mesh Workflow, NLTK, Marvin McMarvelous, fLimfLaMs' },
...
const lbl = () => {
	...
	context.txt = document.getElementById('lbl');
...
const drawAreas = (context) => {
	...
	if (alpha < EPSILON) {
		context.overlay.style.opacity = 1
		return
	}
	context.overlay.style.opacity = .11 + context.percent * .88
